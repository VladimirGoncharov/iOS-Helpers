...
// Helpers
#define COCOAPODS_POD_AVAILABLE_Helpers
#define COCOAPODS_VERSION_MAJOR_Helpers 0
#define COCOAPODS_VERSION_MINOR_Helpers 1
#define COCOAPODS_VERSION_PATCH_Helpers 0
